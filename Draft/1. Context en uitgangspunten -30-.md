...
Zij beschrijven bovendien als enige een model voor inrichting van een open opstelling, gebaseerd op gebruik en met inzet van RFID.[^sunchenbasis]
...
[^sunchenbasis]: In hun beschrijving van voor- en nadelen gaan ze uit van een bestaande situatie waarin gebruikers directe toegang hebben tot al het materiaal. Aangezien wij al beschikken over een gesloten opstelling, is onze uitgangssituatie dus duidelijk anders.
