...
Op drie manieren hebben we informatie verzameld over herinrichting van open opstellingen bij andere bibliotheken in Nederland:

1. door middel van een vraag via de maillijst van de UKB-werkgroep Collectiemanagement
2. door middel van een vraag via de maillijst van vakreferenten Geschiedenis
3. op basis van projectdocumenten van de UB Leiden

De lessen hieruit:

* materiaal moet actueel zijn
* materiaal moet van belang zijn voor huidig onderwijs en/of onderzoek
...
Verschil van inzicht is er over uitleenbaarheid van materiaal. Uit de UKB-werkgroep kwam de aanbeveling om geen niet-uitleenbaar materiaal in open opstelling te plaatsen, maar bijvoorbeeld in Leiden staat alleen niet-uitleenbaar materiaal open opgesteld.
